...
import cn.ning.money.book.vo.AddMenuVO;
import cn.ning.money.book.vo.EditMenuVO;
...
public class MenuController {
    ...
    public Result<?> getPermission(@ApiParam(value = "权限Id") @Validated
        ...
        MenuEntity menuDO = menuService.getById(id);
        if (menuDO == null) {
    ...
    public Result<?> getAll() {
        List<MenuEntity> menuDOS = menuService.getAll();
    ...
    public Result<?> add(@RequestBody @Validated AddMenuVO vo) {
        MenuEntity menuDO = toMenuDO(null, vo.getMenuTitle(), vo.getMenuName(), vo.getParentId(), vo.getOrderNo(), vo.getPath(), vo.getComponent(), vo.getIsOuterChain(), vo.getMenuType(), vo.getPermissionSign(), vo.getIconName());
    ...
    public Result<?> editMenu(@RequestBody @Validated EditMenuVO vo) {
        ...
        MenuEntity menuDO = toMenuDO(Long.valueOf(vo.getId()), vo.getMenuTitle(), vo.getMenuName(), vo.getParentId(), vo.getOrderNo(), vo.getPath(), vo.getComponent(), vo.getIsOuterChain(), vo.getMenuType(), vo.getPermissionSign(), vo.getIconName());
    ...
    private MenuEntity toMenuDO(Long id, String menuTitle, String menuName, Integer parentId, Integer orderNo, String path, String component, Boolean isOuterChain, String menuType, String permissionSign, String iconName) {
