...
import cn.ning.money.book.common.enums.BusinessStatus;
import cn.ning.money.book.common.manager.AsyncManager;
import cn.ning.money.book.common.manager.factory.AsyncFactory;
import cn.ning.money.book.entity.CommonLogEntity;
import cn.ning.money.book.utils.IpUtil;
import cn.ning.money.book.utils.ServletUtil;
import cn.ning.money.book.utils.StringUtil;
...
public class LogAspect implements Ordered {
    ...
    @Pointcut("@annotation(cn.ning.money.book.common.anotations.CommonLog)")
    ...
    private void handleLog(final JoinPoint joinPoint, final Exception e, final Object jsonResult) {
        try {
            ...
            // 添加数据
            CommonLogEntity logDO = new CommonLogEntity();
